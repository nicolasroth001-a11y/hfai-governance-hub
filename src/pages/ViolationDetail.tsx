...
export default function ViolationDetail() {
  ...
  // Extract user message and AI response from conversation
    ...
    <div className="space-y-section">
      <div className="space-y-base">
        ...
        <SectionHeader
          ...
          description="Review violation details and take action"
        />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-section items-start">
        ...
        <div className="lg:col-span-3 space-y-base">
          <RuleCard
            ...
            severity_default={v.rule.severity_default}
            violations_count={18}
          />

          <AIEventViewer
            model={v.ai_event.model}
            user_message={userMessage}
            ai_response={aiResponse}
            prompt_tokens={v.ai_event.prompt_tokens}
            completion_tokens={v.ai_event.completion_tokens}
            latency_ms={v.ai_event.latency_ms}
            confidence_score={v.ai_event.confidence_score}
            context={v.ai_event.context}
          />
