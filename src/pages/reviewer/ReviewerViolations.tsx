...
const columns: DataTableColumn<any>[] = [
  { key: "id", header: "ID", render: (v) => <Link to={`/reviewer/violations/${v.id}`} className="text-primary font-medium hover:underline">{typeof v.id === "string" ? v.id.slice(0, 8) : v.id}</Link> },
...
export default function ReviewerViolations() {
  ...
  return (
    <div className="space-y-8">
      <SectionHeader title="All Violations" description="Violations available for review" />
      <FilterBar filters={[
